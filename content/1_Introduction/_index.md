...
The purpose of this site is to provide a quick start guide for using Infrastructure as Code (IaC) templates located in the repo [**fortigate-aws-tgwconnect-ha-dualaz-terraform**](https://github.com/FortinetCloudCSE/fortigate-aws-tgwconnect-ha-dualaz-terraform).
